...
## $ export DEBUG_LEFTWMRC_GET=true
is_debug () {
	if [ "$DEBUG_LEFTWMRC_GET" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME='leftwmrc-get'
	fi

	THE_CMD_FILE_PATH="${THE_CMD_DIR_PATH}/$THE_CMD_FILE_NAME"

	## https://github.com/samwhelp/note-about-leftwm/blob/gh-pages/_demo/project/leftwmrc-profile/leftwmrc-get/leftwmrc-get
	THE_SELF_UPDATE_URL='https://raw.githubusercontent.com/samwhelp/note-about-leftwm/gh-pages/_demo/project/leftwmrc-profile/leftwmrc-get/leftwmrc-get'
	...
	THE_LEFTWMRC_FILE_NAME="leftwm.conf"
	THE_LEFTWMRC_FILE_PATH="$THE_LEFTWMRC_DIR_PATH/$THE_LEFTWMRC_FILE_NAME"

	## leftwmrc-profile
	THE_LEFTWMRC_PROFILE_DIR_NAME="leftwmrc-profile"
	THE_LEFTWMRC_PROFILE_DIR_PATH="$HOME/.local/share/$THE_LEFTWMRC_PROFILE_DIR_NAME"
...
base_var_dump () {
	...
	util_debug_echo "THE_LEFTWMRC_FILE_NAME=$THE_LEFTWMRC_FILE_NAME"
	util_debug_echo "THE_LEFTWMRC_FILE_PATH=$THE_LEFTWMRC_FILE_PATH"

	util_debug_echo "THE_LEFTWMRC_PROFILE_DIR_NAME=$THE_LEFTWMRC_PROFILE_DIR_NAME"
	util_debug_echo "THE_LEFTWMRC_PROFILE_DIR_PATH=$THE_LEFTWMRC_PROFILE_DIR_PATH"
