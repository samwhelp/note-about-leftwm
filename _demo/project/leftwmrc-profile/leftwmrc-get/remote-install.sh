...
# * https://github.com/samwhelp/note-about-leftwm/blob/gh-pages/_demo/project/leftwmrc-profile/leftwmrc-get/remote-install.sh
# * https://github.com/samwhelp/note-about-leftwm/blob/gh-pages/_demo/project/leftwmrc-profile/leftwmrc-get/leftwmrc-get
# * https://raw.githubusercontent.com/samwhelp/note-about-leftwm/gh-pages/_demo/project/leftwmrc-profile/leftwmrc-get/leftwmrc-get
...
## $ export DEBUG_LEFTWMRC_GET_INSTALL=true
is_debug () {
	if [ "$DEBUG_LEFTWMRC_GET_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="leftwmrc-get-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-leftwm/blob/gh-pages/_demo/project/leftwmrc-profile/leftwmrc-get/leftwmrc-get
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-leftwm/gh-pages/_demo/project/leftwmrc-profile/leftwmrc-get/leftwmrc-get'


	THE_TARGET_FILE_NAME="leftwmrc-get"
