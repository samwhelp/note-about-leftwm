...
# * https://github.com/samwhelp/note-about-leftwm/blob/gh-pages/_demo/project/leftwmrc-profile/leftwmrc-ctrl/remote-install.sh
# * https://github.com/samwhelp/note-about-leftwm/blob/gh-pages/_demo/project/leftwmrc-profile/leftwmrc-ctrl/leftwmrc-ctrl
# * https://raw.githubusercontent.com/samwhelp/note-about-leftwm/gh-pages/_demo/project/leftwmrc-profile/leftwmrc-ctrl/leftwmrc-ctrl
...
## $ export DEBUG_LEFTWMRC_CTRL_INSTALL=true
is_debug () {
	if [ "$DEBUG_LEFTWMRC_CTRL_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="leftwmrc-ctrl-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-leftwm/blob/gh-pages/_demo/project/leftwmrc-profile/leftwmrc-ctrl/leftwmrc-ctrl
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-leftwm/gh-pages/_demo/project/leftwmrc-profile/leftwmrc-ctrl/leftwmrc-ctrl'


	THE_TARGET_FILE_NAME="leftwmrc-ctrl"
